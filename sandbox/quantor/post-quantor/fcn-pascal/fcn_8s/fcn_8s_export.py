...
parser = argparse.ArgumentParser(description='FCN 8s Export')
parser.add_argument('--ckpt_dir', default='./fcn_8s/ckpts', help='ckpt_dir')
parser.add_argument('--slim_dir', default='/home/tflite/models/research/slim', help='slim_dir')
parser.add_argument('--output_file', default='./fcn_8s/models/frozen.pb', help='output model file')
...
with tf.Session() as sess:
    ...
    # import ipdb
    # ipdb.set_trace()
    freeze_graph_def = graph_util.convert_variables_to_constants(sess, graph_def, ["fcn_8s/prediction"])
