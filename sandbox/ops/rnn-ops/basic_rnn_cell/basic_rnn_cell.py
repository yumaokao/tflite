...
Links:
    [Long Short Term Memory](http://deeplearning.cs.cmu.edu/pdfs/Hochreiter97_rnn.pdf)
...
def RNN(x, weights, biases):
    ...
    # Get rnn cell output
    # outputs, states = rnn.static_rnn(rnn_cell, x, initial_state=initial_state, dtype=tf.float32)
    output, state = rnn_cell(x, state)
    output_1, state = rnn_cell(x, state)
