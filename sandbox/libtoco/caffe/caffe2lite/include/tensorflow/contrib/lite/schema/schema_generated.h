...
enum BuiltinOperator {
  ...
  BuiltinOperator_QUANTIZE = 60,
  BuiltinOperator_TRANSPOSE_CONV = 61,
...
enum BuiltinOptions {
  ...
  BuiltinOptions_DepthToSpaceOptions = 36,
  BuiltinOptions_TransposeConvOptions = 37,
  BuiltinOptions_DilatedConvOptions = 38,
...
struct TransposeConvOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int32_t out_shape_N() const {
    return GetField<int32_t>(VT_OUT_SHAPE_N, 0);
  }
  int32_t out_shape_H() const {
    return GetField<int32_t>(VT_OUT_SHAPE_H, 0);
  }
  int32_t out_shape_W() const {
    return GetField<int32_t>(VT_OUT_SHAPE_W, 0);
  }
  int32_t out_shape_C() const {
    return GetField<int32_t>(VT_OUT_SHAPE_C, 0);
  }
  ActivationFunctionType fused_activation_function() const {
    return static_cast<ActivationFunctionType>(GetField<int8_t>(VT_FUSED_ACTIVATION_FUNCTION, 0));
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int32_t>(verifier, VT_STRIDE_W) &&
           VerifyField<int32_t>(verifier, VT_STRIDE_H) &&
           VerifyField<int32_t>(verifier, VT_OUT_SHAPE_N) &&
           VerifyField<int32_t>(verifier, VT_OUT_SHAPE_H) &&
           VerifyField<int32_t>(verifier, VT_OUT_SHAPE_W) &&
           VerifyField<int32_t>(verifier, VT_OUT_SHAPE_C) &&
           VerifyField<int8_t>(verifier, VT_FUSED_ACTIVATION_FUNCTION) &&
           verifier.EndTable();
  }
...
struct TransposeConvOptionsBuilder {
  ...
  void add_out_shape_N(int32_t out_shape_N) {
    fbb_.AddElement<int32_t>(TransposeConvOptions::VT_OUT_SHAPE_N, out_shape_N, 0);
  }
  void add_out_shape_H(int32_t out_shape_H) {
    fbb_.AddElement<int32_t>(TransposeConvOptions::VT_OUT_SHAPE_H, out_shape_H, 0);
  }
  void add_out_shape_W(int32_t out_shape_W) {
    fbb_.AddElement<int32_t>(TransposeConvOptions::VT_OUT_SHAPE_W, out_shape_W, 0);
  }
  void add_out_shape_C(int32_t out_shape_C) {
    fbb_.AddElement<int32_t>(TransposeConvOptions::VT_OUT_SHAPE_C, out_shape_C, 0);
  }
  void add_fused_activation_function(ActivationFunctionType fused_activation_function) {
...
inline flatbuffers::Offset<TransposeConvOptions> CreateTransposeConvOptions(
    ...
    int32_t stride_w = 0,
    int32_t stride_h = 0,
    int32_t out_shape_N = 0,
    int32_t out_shape_H = 0,
    int32_t out_shape_W = 0,
    int32_t out_shape_C = 0,
    ActivationFunctionType fused_activation_function = ActivationFunctionType_NONE) {
  TransposeConvOptionsBuilder builder_(_fbb);
  builder_.add_out_shape_C(out_shape_C);
  builder_.add_out_shape_W(out_shape_W);
  builder_.add_out_shape_H(out_shape_H);
  builder_.add_out_shape_N(out_shape_N);
  builder_.add_stride_h(stride_h);
  builder_.add_stride_w(stride_w);
  builder_.add_fused_activation_function(fused_activation_function);
  builder_.add_padding(padding);
...
inline void TransposeConvOptions::UnPackTo(TransposeConvOptionsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = stride_w(); _o->stride_w = _e; };
  { auto _e = stride_h(); _o->stride_h = _e; };
  { auto _e = out_shape_N(); _o->out_shape_N = _e; };
  { auto _e = out_shape_H(); _o->out_shape_H = _e; };
  { auto _e = out_shape_W(); _o->out_shape_W = _e; };
  { auto _e = out_shape_C(); _o->out_shape_C = _e; };
  { auto _e = fused_activation_function(); _o->fused_activation_function = _e; };
}
...
inline flatbuffers::Offset<TransposeConvOptions> CreateTransposeConvOptions(flatbuffers::FlatBufferBuilder &_fbb, const TransposeConvOptionsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _stride_w = _o->stride_w;
  auto _stride_h = _o->stride_h;
  auto _out_shape_N = _o->out_shape_N;
  auto _out_shape_H = _o->out_shape_H;
  auto _out_shape_W = _o->out_shape_W;
  auto _out_shape_C = _o->out_shape_C;
  auto _fused_activation_function = _o->fused_activation_function;
